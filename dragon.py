...
while True:
    try:
        ...
        # Nomes dos jogos
        nomes_jogos = ["Fortune Tiger", "Fortune Ox", "Fortune Mouse", "Fortune Rabbit", "Fortune Dragon"]
        emojis_jogos = ["🐯", "🐀", "🐂", "🐇", "🐉"]

        entrada = f'''🟢💰 Entrada Fortune Dragon Confirmada! 💰🟢

{emojis_jogos[4]}<a href="https://mundialsbet.com/casino/pgsoft/fortune-dragon">{nomes_jogos[4]}</a>
